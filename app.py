#!/usr/bin/env python3
# ============================================================
# ZYXX API GENERATOR - FLASK MENTAH
# Password: ZYXXCORE-888288
# ============================================================
...
REGION_LANG = {"ID":"id","VN":"vi","TH":"th","MY":"ms","SG":"en","HK":"zh"}
...
def gen():
    ...
    if key != API_KEY:
        return jsonify({"error": "Invalid API key. Use ?key=ZYXXCORE-888288"}), 401
    ...
    if count > 100:
        return jsonify({"error": "Max 100 per request"}), 400
...
def home():
    return jsonify({
        "message": "ZYXX API GENERATOR",
        "key": "ZYXXCORE-888288",
        "endpoint": "/gen?key=ZYXXCORE-888288&count=10&name=ZYXX&region=ID",
        "max_count": 100
    })
